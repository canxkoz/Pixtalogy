...
files = glob.glob('/home/admin/dataset/ct-scans/train_images/img/*.JPG')
...
conversation = [
    {
        ...
        "content": [
            ...
            {"type": "text", "text": "You are an expert radiologist. Provide an evaluation for the chest X-Ray scan on the image.\n"},
            {
                "type": "image",
            }
        ],
